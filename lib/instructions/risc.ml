...
let string_of_regs r1 r2 r3 =
  string_of_reg r1 ^ " " ^ string_of_reg r2 ^ " " ^ string_of_reg r3
...
let print_risc = function
  ...
  | AND (r1, r2, r3) -> print_endline ("AND " ^ string_of_regs r1 r2 r3)
  | XOR (r1, r2, r3) -> print_endline ("XOR " ^ string_of_regs r1 r2 r3)
